      ...
      <div className="relative flex flex-col items-start justify-start h-auto px-3 py-10 tracking-tighter transition-all duration-200 xl:px-10 xs:px-3 sm:px-5 md:px-6 animate-fadeIn lg:px-8">
        ...
        <div className="flex flex-col w-full h-auto gap-4 my-2 text-justify lg:flex-row lg:items-start lg:justify-between">
          <p className="flex justify-start  items-start text-slate-500 flex-start font-manrope text-sm sm:text-md md:text-lg lg:text-lg xl:text-lg lg:w-[50%] animate-fadeInFromLeft ">
            ...
            all-inclusive tour packages. Immerse yourself in the natural beauty
            of this picturesque region, where lush green valleys meet towering
            mountains. Whether you crave thrilling adventures, cultural
            experiences, or peaceful relaxation, our packages cater to your
            every desire. Indulge in luxurious accommodations amidst
            breathtaking scenery, ensuring a perfect blend of comfort and
            immersion in nature. With seamless transportation and flexible
            durations, enjoy hassle-free travel tailored to your schedule. From
            cozy hotel stays with modern amenities to personalized itineraries
            showcasing the best of Swat Valley, every detail is planned to make
            your trip unforgettable. Let us handle the logistics while you focus
            on creating cherished memories in one of Pakistan's most captivating
            destinations. Your adventure awaits—book your Swat Valley tour
            today!
          </p>
          <img
            src={thumbnailimage}
