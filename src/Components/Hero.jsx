...
const Hero = () => {
  return (
    <div className="relative flex flex-col items-start justify-start h-auto px-3 py-10 tracking-tighter transition-all duration-200 bg-green-400 animate-fadeIn">
