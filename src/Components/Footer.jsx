...
const Footer = () => {
  return (
    <div className="items-start justify-around w-full p-8 text-white bg-green-900 xs:flex xs:flex-col sm:flex sm:flex-row md:flex md:flex-row lg:flex lg:flex-row">
      <img
        src={logo}
        alt="Logo"
      ...
      <div className="flex-col items-start justify-center h-full title md:w-96">
        <h1 className="w-full my-2 text-5xl font-extrabold text-center text-slate-100">
          The Swat Tours
        </h1>
        <p className="my-2 text-slate-100 md:w-fit">
      ...
      <div className="flex flex-col items-start justify-center w-full h-full gap-2 pages-content md:w-fit ">
      ...
      <div className="flex flex-col items-start w-full gap-2 mt-4 xs:pt-4 md:p-0 md:w-fit misc-pages text-slate-200">
